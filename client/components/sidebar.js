...
export function renderSidebar(router) {
  ...
  const sidebarHTML = `
    <div class="fixed top-12 left-0 w-16 bg-gradient-to-b from-purple-700 via-purple-600 to-indigo-700 text-white z-10 flex flex-col justify-between transition-all duration-300" id="sidebar-menu" data-collapsed="true" style="height: calc(100vh - 3rem - 2rem);">
      <!-- Sidebar menu items -->
